...
@TableName("t_billboard_talent_related")
@ApiModel(value="BillboardTalentRelated对象", description="榜单与帅才的匹配关联表")
public class BillboardTalentRelated implements Serializable {
